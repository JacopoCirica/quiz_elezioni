...
function showQuetion(index){
    ...
    let option_tag = '<div class="domanda"><p>Chi lo dice?</p></div><div class="prova2"><img class= "dot" id= "' + questions[index].options[0] + '" src="/img/' + questions[index].options[0] + '.png"></span> <p class=didascalia>'+ questions[index].options[0] + '</p></div>'
    +'<div class="prova2"><img class= "dot" id= "' + questions[index].options[1] + '" src="/img/' + questions[index].options[1] + '.png"></span> <p class=didascalia>'+ questions[index].options[1] + '</p></div>'
    +'<div class="prova2"><img class= "dot" id= "' + questions[index].options[2] + '" src="/img/' + questions[index].options[2] + '.png"></span> <p class=didascalia>'+ questions[index].options[2] + '</p></div>'
    +'<div class="prova2"><img class= "dot" id= "' + questions[index].options[3] + '" src="/img/' + questions[index].options[3] + '.png"></span> <p class=didascalia>'+ questions[index].options[3] + '</p></div>'
    +'<div class="prova2"><img class= "dot" id= "' + questions[index].options[4] + '" src="/img/' + questions[index].options[4] + '.png"></span> <p class=didascalia>'+ questions[index].options[4] + '</p></div></div>';
...
function optionSelected(answer){
    ...
    if(userAns == correcAns){ //if user selected option is equal to array's correct answer
        ...
        let id_logo= '#' + answer.textContent
        let logo_correct = document.querySelector(id_logo);
        logo_correct.classList.add("correct");
        //answer.classList.add("correct"); //adding green color to correct selected option
        let tickIconTag = '<div class="icon tick">bravo</div>';
        answer.insertAdjacentHTML("afterend", tickIconTag); //adding tick icon to correct selected option
        console.log("Correct Answer");
        console.log("Your correct answers = " + userScore);
        console.log(answer.textContent)
    }else{
        //answer.classList.add("incorrect"); //adding red color to correct selected option
        let crossIconTag = '<div class="icon tick">sbagliato</div>'
        let id_logo= '#' + answer.textContent
        if(id_logo==='#Forza Italia'){
            id_logo='#Forza'
        }
        let logo_correct = document.querySelector(id_logo);
        logo_correct.classList.add("incorrect");
